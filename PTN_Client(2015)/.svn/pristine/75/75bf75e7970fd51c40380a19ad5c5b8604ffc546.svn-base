...
import com.nms.ui.ptn.alarm.controller.HisAlarmController;
 ...
 * 
 */
public class HisAlarmPanel extends JPanel {
	...
	private HisAlarmController controller;
	...
	public void init() {
		...
		setLayout();
		addListention();
		controller = new HisAlarmController(this);
		controller.refresh();
	}
	...
	private void addListention() {
		...
		this.alarmTable.addAlarmClickedActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Element element = HisAlarmPanel.this.box.getElementByID(alarm.getElementID());
				HisAlarmPanel.this.box.getSelectionModel().setSelection(element);
			}
		});
	...
	public HisAlarmController getController() {
		return controller;
	}
