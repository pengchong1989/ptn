 ...
 * @author __USER__
 */
public class SelectSiteDialog extends javax.swing.JDialog {
	...
	public SelectSiteDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}

	public SelectSiteDialog(TNetwork network, boolean modal) {
		this.setModal(modal);
		initComponents();
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		elementList = network.getDataBox().getAllElements();
		List<Element> elementList1 = network.getDataBox().getAllElements();
...
//					}
		...
		if (!siteIdexist) {
			DialogBoxUtil.errorDialog(this, ResourceUtil.srcStr(StringKeysTip.TIP_SITENONENTILY));
		} else {
			dispose();
		}
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				SelectSiteDialog dialog = new SelectSiteDialog(new javax.swing.JFrame(), true);
