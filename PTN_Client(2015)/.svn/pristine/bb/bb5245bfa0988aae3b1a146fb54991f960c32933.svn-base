...
//	private GridBagLayout gridBagLayout = null;
	...
	private void initData() {
		...
		try {
			...
			// LM发送周期
			super.getComboBoxDataUtil().comboBoxSelect(this.lmSendCycleLableComboBox, String.valueOf(oamEthernetInfo.getLmSendCycle()));
			// DM使能
	...
	private void initComponent() {
		try {
			...
			tstPurposeMepMacLabelTextField = new PtnTextField();
...
//			oamEthernetInfo.setMipPortName(portInsts.getPortName());
			...
			//添加日志记录
			this.confirm.setOperateKey(EOperationLogType.ETHERNETOAMINSERT.getValue());
 ...
 private void setLckJpanelComponentLayout() {
	...
	public void isValue() {
		if (mdNameLabelTextField.getText() != null && !"".equals(mdNameLabelTextField.getText())) {
			...
			dmPriorityLabel.setEnabled(false);
			...
			dmPriorityLabel.setEnabled(true);
