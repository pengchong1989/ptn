...
import com.nms.ui.ptn.ne.ecn.ospf.areaconfig.controller.SaveAddressPanelController;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class SavaAdreePanel extends ContentView<PortStm>{
	public SavaAdreePanel() {
		super("addaddress",RootFactory.CORE_MANAGE);
		init();
	}
...
//		splitPane.setOneTouchExpandable(true);
	...
	public void setController() {
		controller = new SaveAddressPanelController(this);
	}
