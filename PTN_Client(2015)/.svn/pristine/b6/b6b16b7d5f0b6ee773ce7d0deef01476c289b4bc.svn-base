 ...
 * @author __USER__
 */
public class EquipmentDialog extends javax.swing.JDialog {

	private static final long serialVersionUID = 2476766822850317381L;
	...
	public EquipmentDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}

	public EquipmentDialog(boolean modal, final SiteInst siteInst) {
		this.setModal(modal);
		try {
			this.panelLayout();
	...
	public void createTopo() throws Exception {
		...
		try {
			...
			siteInst = siteServiceMB.select(siteInst).get(0);
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				EquipmentDialog dialog = new EquipmentDialog(new javax.swing.JFrame(), true);
