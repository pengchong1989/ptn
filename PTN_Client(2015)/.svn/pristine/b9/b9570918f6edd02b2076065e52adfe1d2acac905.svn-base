package com.nms.ui.ptn.ne.ecn.ospf.ospfstatus.view;
...
public class OSPFStatusPanel extends ContentView<PortStm>{
	public OSPFStatusPanel() {
		super("ospfstatusTable",RootFactory.CORE_MANAGE);
		init();
	}
