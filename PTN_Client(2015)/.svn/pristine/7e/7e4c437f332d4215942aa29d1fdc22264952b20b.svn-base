...
import com.nms.ui.ptn.ne.eline.controller.ElineController;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class ElinePanel extends ContentView<ElineInfo> {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8544845032634157008L;
	...
	public ElinePanel() {
		super("elineNodeTable",RootFactory.CORE_MANAGE);
		try {
			this.init();
	...
	private void setActionListention() {
		...
		activeItem.addActionListener(new MyActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				((ElineController) getController()).doActive();
			}
		...
		unActiveItem.addActionListener(new MyActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				((ElineController) getController()).doUnActive();
			}
	...
	public void setController() {
		super.controller = new ElineController(this);
	}
