 ...
 *
 */
public class PortInfoController extends AbstractController{
	private PortInfoPanel view;

	PortInfoController(PortInfoPanel portInfoPanel){
	...
	public PortInfoPanel getView() {
		return view;
	}

	public void setView(PortInfoPanel view) {
		this.view = view;
	}
}
