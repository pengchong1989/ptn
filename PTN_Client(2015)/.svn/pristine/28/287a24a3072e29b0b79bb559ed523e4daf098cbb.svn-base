...
public class Port2LayerAttr extends ViewDataObj {
	...
	private String tpIdTypeLog;//入匹配TPID类型,log日志用到
	...
	private String qinqModelLog;//qinq模式,log日志用到
	private String vlans;//vlan值
	private String qinqs;//qinq配置
	private int qinqCount;//qinq条目数
	private List<CommonBean> qinQVlanLimit;//QinQ的上下限以及vlanId的组合,log日志用到
	
	public String getQinqModelLog() {
		return qinqModelLog;
	}

	public void setQinqModelLog(String qinqModelLog) {
		this.qinqModelLog = qinqModelLog;
	}

	public String getTpIdTypeLog() {
		return tpIdTypeLog;
	}

	public void setTpIdTypeLog(String tpIdTypeLog) {
		this.tpIdTypeLog = tpIdTypeLog;
	}

	public List<CommonBean> getQinQVlanLimit() {
		return qinQVlanLimit;
	}

	public void setQinQVlanLimit(List<CommonBean> qinQVlanLimit) {
