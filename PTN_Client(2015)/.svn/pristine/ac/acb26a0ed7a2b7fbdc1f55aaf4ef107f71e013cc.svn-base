 ...
 * 
 */
public class SelectedTunnelPanel extends JPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4897605334693326804L;
	 ...
	 * 创建一个新的实例
	 */
	public SelectedTunnelPanel(List<Tunnel> tunnelList) {
		this.initComponent();
		this.setLayout();
	...
	private void setLayout() {
		this.setBorder(BorderFactory.createTitledBorder(ResourceUtil.srcStr(StringKeysPanel.PANEL_SELECTED_TUNNEL)));
