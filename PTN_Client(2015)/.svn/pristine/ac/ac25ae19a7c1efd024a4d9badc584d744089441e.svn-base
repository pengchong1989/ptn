package com.nms.ui.ptn.ne.ecn.ospf.ospfinterfacesmessage.view;
...
public class OspfInterfacesMessagePanel extends ContentView<PortStm> {
	public OspfInterfacesMessagePanel() {
		super("ospfmessageTable",RootFactory.CORE_MANAGE);
		init();
	}
