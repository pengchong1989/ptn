...
import com.nms.ui.ptn.alarm.controller.SiteOamEventController;
 ...
 * 
 */
public class SiteOamEventPanel extends ContentView<OamEvent> {

	private static final long serialVersionUID = 1L;

	private JTabbedPane tabbedPane; // 选项卡控件
	private JSplitPane splitPane; // 上下分割控件
	private SiteOamEventPanel Panel = null; // OamEvent信息panel

	/**
	 * 创建一个新实例
	 */
	public SiteOamEventPanel() {	
		super("oamEvent",RootFactory.CORE_MANAGE);
		try {
			this.initComponent();
			this.setLayout();
			this.addListention();
...
//	}
	...
	public void setController() {
		super.controller = new SiteOamEventController(this);
	}

	public SiteOamEventPanel getOamEventPanel() {
		return Panel;
	}
}
