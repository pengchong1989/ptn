...
public interface PwInfoMapper {
     ...
     * @param tid
     */
	public void updateTunnelID(Map<String, Object> map);
	...
	public PwInfo queryByPwidCondition_notjoin(PwInfo pwinfo);
	...
	public List<PwInfo> queryByType(Map<String, Object> map);
	
	public void updateStatus(Map<String, Object> map);

	public List<PwInfo> selectMsPwByPwId(PwInfo pwInfo);
