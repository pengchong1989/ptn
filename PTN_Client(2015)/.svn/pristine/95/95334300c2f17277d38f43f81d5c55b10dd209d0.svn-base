...
import com.nms.ui.ptn.statistics.lable.LableInfoController;

public class UsedLabelFilterDialog extends PtnDialog{
	...
	private LableInfoController controller;
	private List<String> typeList = new ArrayList<String>();
	
	public UsedLabelFilterDialog(AbstractController controller){
		this.setModal(true);
		this.controller = (LableInfoController) controller;
		this.initComponents();
		this.setLayout();
		this.initData();
		this.addListener();
	...
	private void saveBtnAction() {
		...
		if("PW".equals(con.getName())){
			...
			try {
				...
				this.controller.filterByPw(siteIdList);
			} catch (Exception e) {
				ExceptionManage.dispose(e,this.getClass());
			}
		}else{
