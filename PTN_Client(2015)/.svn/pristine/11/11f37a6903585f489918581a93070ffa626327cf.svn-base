...
public class MsPwInfo extends ViewDataObj implements java.io.Serializable {
	...
	private String frontTunnelName;
	private int backTunnelId;
	private String backTunnelName;
	...
	public String getFrontTunnelName() {
		return frontTunnelName;
	}
	public void setFrontTunnelName(String frontTunnelName) {
		this.frontTunnelName = frontTunnelName;
	}
	public String getBackTunnelName() {
		return backTunnelName;
	}
	public void setBackTunnelName(String backTunnelName) {
		this.backTunnelName = backTunnelName;
	}
