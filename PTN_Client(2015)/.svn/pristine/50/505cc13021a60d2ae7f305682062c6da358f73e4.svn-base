...
public class Acbuffer extends ViewDataObj implements Serializable{
	...
	private String uniBuffer = "uniBuffer";
	private int id;
	private int acId;
	private int bufferEnable;
	private int model;
	private int modelLog;//log日志用到
	private int vlanId;
	private int cir;
	...
	private int strategyLog;//log日志用到
	private int ipDscp;
	private int phb;
...
/*	private String sinkIpLabelValue;
	...
	public String getUniBuffer() {
		return uniBuffer;
	}

	public void setUniBuffer(String uniBuffer) {
		this.uniBuffer = uniBuffer;
	}
	public int getPortType() {
		return portType;
	}
	public int getModelLog() {
		return modelLog;
	}
	public void setModelLog(int modelLog) {
		this.modelLog = modelLog;
	}
	public int getStrategyLog() {
		return strategyLog;
	}
	public void setStrategyLog(int strategyLog) {
