 ...
 *
 */
public class ProfessController extends AbstractController{
	private ProfessPanel view;
	private List<Integer> portIdList = new ArrayList<Integer>();
	private List<Integer> siteIdList = new ArrayList<Integer>();
	
	public ProfessController(ProfessPanel professPanel){
	...
	public ProfessPanel getView() {
		return view;
	}

	public void setView(ProfessPanel view) {
		this.view = view;
	}
	/**
	 * pw类型根据网元过滤
