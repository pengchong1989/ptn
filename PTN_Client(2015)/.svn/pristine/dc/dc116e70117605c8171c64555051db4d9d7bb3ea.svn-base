package com.nms.ui.ptn.ne.ecn.ospf.ospfinterfacesrun.view;
...
public class OspfinterfacesRunstatusPanel extends ContentView<PortStm> {
	public OspfinterfacesRunstatusPanel() {
		super("ospfrunstatusTable",RootFactory.CORE_MANAGE);
		init();
	}
