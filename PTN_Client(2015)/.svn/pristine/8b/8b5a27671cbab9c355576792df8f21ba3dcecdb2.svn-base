...
public class PWTopology extends javax.swing.JDialog {
	...
	public PWTopology(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}

	public PWTopology(boolean modal, final SiteInst siteInst,  final String type , final Element element)  {
		this.setModal(modal);
		try {
			this.panelLayout();
	...
	private void setPath(SiteInst siteInst, PortInst portInst, String type) {
		...
		AddElineDialog addpwdialog = null;
...
//			addpwdialog = AddElineDialog.getDialog();
//			if (type.equals("A")) {
//				addpwdialog.setPortInst_a(portInst);
//			} else if(type.equals("Z")){
//				addpwdialog.setPortInst_z(portInst);
//			}
			...
			for (SlotInst slotInst : siteInst.getEquipInst().getSlotlist()) {
				...
				if (null != slotInst.getCardInst()) {
					...
					if (slotInst.getCardInst().getPortList() != null) {
						for (PortInst portInst : slotInst.getCardInst()
								.getPortList()) {
	...
	private void panelLayout() {
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(
				...
				jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 168,
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 618,
				Short.MAX_VALUE));
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				PWTopology dialog = new PWTopology(
