...
public interface TunnelMapper {
	...
	void updateProtectTunnelID(Map<String, Object> map);

	/**
	 * 搜索时，批量删除
	 * @param tid
	 */
	void deleteByTunnelIds(@Param("ids")List<Integer> ids);
	...
	List<Tunnel> selectAllNotProtect();

	public List<Tunnel> queryTunnelByName(String tunnelName);
