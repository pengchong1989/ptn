...
public class PortUniAttr implements Serializable {
	...
	private String broadcast;//广播报文抑制=武汉 广播包流量
	private int isUnicast;//洪泛包抑制开关 0=false 1=true
	private String unicast;//单播报文抑制=洪泛包流量
	private int isMulticast;//组播包抑制开关 0=false 1=true
	private String multicast;//组播报文抑制=组播包流量
	...
	private int destinationIpRelevance;//目的IP地址关联设置 0=false 1=true
