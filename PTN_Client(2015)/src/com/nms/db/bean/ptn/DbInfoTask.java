...
public class DbInfoTask {
	 ...
	 /**数据库Id*/
	private int ptnDb_instPath_id = 0;
	 /** 监控类型 数据库空间*/
	...
	public int getPtnDb_instPath_id() {
		return ptnDb_instPath_id;
	}

	public void setPtnDb_instPath_id(int ptnDbInstPathId) {
		ptnDb_instPath_id = ptnDbInstPathId;
	}
