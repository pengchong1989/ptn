...
import com.nms.ui.ptn.performance.controller.HisPerformanceController;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class HisPerformancePanel extends ContentView<HisPerformanceInfo> {
	private static final long serialVersionUID = 6306612170631181766L;
	private JFileChooser fileChooser=null;

	public HisPerformancePanel() {
		super("hisPerTable",RootFactory.PROFOR_MANAGE);
		init();
	}
...
//			getController().refresh();
	...
	public void setController() {
		controller = new HisPerformanceController(this);
	}
