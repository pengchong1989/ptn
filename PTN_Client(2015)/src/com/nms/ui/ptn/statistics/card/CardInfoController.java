 ...
 *
 */
public class CardInfoController extends AbstractController{
	private CardInfoPanel view;

	CardInfoController(CardInfoPanel cardInfoPanel){
	...
	public CardInfoPanel getView() {
		return view;
	}

	public void setView(CardInfoPanel view) {
		this.view = view;
	}
}
