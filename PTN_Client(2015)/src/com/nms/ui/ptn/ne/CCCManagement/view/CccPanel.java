...
import com.nms.ui.ptn.ne.CCCManagement.controller.CccController;
import com.nms.ui.ptn.ne.eline.view.AcElinePanel;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class CccPanel extends ContentView<CccInfo>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2825129939232800310L;
	...
	public CccPanel() {
		super("CccTable",RootFactory.CORE_MANAGE);
		try {
			this.init();
	...
	private void init() {
		getContentPanel().setBorder(BorderFactory.createTitledBorder(ResourceUtil.srcStr(StringKeysTab.TAB_CCCINFO)));
		initComponent();
		setLayout();
	...
	private void setActionListention() {
		...
		activeItem.addActionListener(new MyActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				((CccController) getController()).doActive();
			}
		...
		unActiveItem.addActionListener(new MyActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				((CccController) getController()).doUnActive();
			}
	...
	private void setInfoPanelLayout() {
		...
		qosGridBagLayout.columnWeights = new double[] {1.0};
	...
	public void setController() {
		super.controller=new CccController(this);
	}
