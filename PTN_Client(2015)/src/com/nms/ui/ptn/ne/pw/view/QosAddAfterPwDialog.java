...
import com.nms.ui.ptn.ne.pw.controller.QosAddAfterPwDialogContorller;

public class QosAddAfterPwDialog extends PtnDialog {

	private static final long serialVersionUID = -6979965702487689161L;
	private QosAddAfterPwDialogContorller contorller;
	...
	public QosAddAfterPwDialog(PwInfo pwinfo) {
		setModal(true);
		initComponent();
		setLayout();
		setPwInfo(pwinfo);
		contorller=new QosAddAfterPwDialogContorller(this);
	}
	...
	public QosAddAfterPwDialogContorller getContorller() {
		return contorller;
	}

	public void setContorller(QosAddAfterPwDialogContorller contorller) {
