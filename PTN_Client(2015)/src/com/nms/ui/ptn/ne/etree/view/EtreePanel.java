...
import com.nms.ui.ptn.ne.etree.controller.EtreeController;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class EtreePanel extends ContentView<EtreeInfo>{
	...
	public EtreePanel() {
		super("etreeNodeTable",RootFactory.CORE_MANAGE);
		try {
			this.init();
	...
	private void setActionListention() {
		...
		activeItem.addActionListener(new MyActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				((EtreeController) getController()).doActive();
			}
		...
		unActiveItem.addActionListener(new MyActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				((EtreeController) getController()).doUnActive();
			}
	...
	public void setController() {
		super.controller=new EtreeController(this);
	}
