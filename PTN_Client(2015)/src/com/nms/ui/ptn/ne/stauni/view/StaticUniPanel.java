...
import com.nms.ui.ptn.ne.stauni.controller.StaticUniController;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class StaticUniPanel extends ContentView<StaticUnicastInfo>{

	private static final long serialVersionUID = 1L;
	
	public StaticUniPanel(){
		super("StaticUniTable",RootFactory.CORE_MANAGE);
		init();
		
	}
	
	private void init(){
		getContentPanel().setBorder(BorderFactory.createTitledBorder(ResourceUtil.srcStr(StringKeysPanel.PANEL_STATIC_MANAGE)));
		setLayout();
		try {
	...
	public void setController() {
		controller = new StaticUniController(this);
	}
