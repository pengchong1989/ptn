...
import com.nms.ui.ptn.ne.sdh.controller.SDHPanelController;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class SDHPanel extends ContentView<PortStm>{
	public SDHPanel() {
		super("stmTable",RootFactory.CORE_MANAGE);
		init();
	}

	private void init() {
		getContentPanel().setBorder(BorderFactory.createTitledBorder(ResourceUtil.srcStr(StringKeysPanel.PANEL_SDH_PORT_MANAGE)));
		this.initComponents();
		setLayout();
		try {
	...
	private void initComponents() {
		...
		tabbedPane.addTab(ResourceUtil.srcStr(StringKeysTab.TAB_SEGMENT_PAY_EXPENSES), segmentPanel);
		tabbedPane.addTab(ResourceUtil.srcStr(StringKeysTab.TAB_HIGH_GALLERY), heightScrollPane);
