...
import com.nms.ui.ptn.clock.controller.ClockPanelControllerBottomCX;
import com.nms.ui.ptn.safety.roleManage.RootFactory;

public class TabPanelTwoBottomTCX extends ContentView<TodConfigInfo> {

	private static final long serialVersionUID = -5136895060981667594L;

	private GridBagLayout gridBagLayout = null;

	public TabPanelTwoBottomTCX() {

		super("TODConfig",RootFactory.CORE_MANAGE);
		try {
	...
	public void setController() {
		...
		controller = new ClockPanelControllerBottomCX(this);
	...
	/**
	 * <p>
	 * 去掉不需要用到的按钮‘search’、‘add’、‘synchronize’和‘delete’
	 * </p>
	 */
	@Override
	public List<JButton> setNeedRemoveButtons() {
		...
		needButtons.add(super.getSynchroButton());
		return needButtons;
	}
