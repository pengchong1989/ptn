...
,MOServerLookupListener
{
  ...
  private static final LogAdapter LOGGER = 
      LogFactory.getLogger(TopologicalLink.class);
...
//--AgentGen END
   ...
   */
  public static final OID oidTopologicalLink =
    new OID(new int[] {  });
  ...
  public static final OID oidMyEntry = 
    new OID(new int[] { 1,3,6,1,4,1,44484,1,8,2,1 });

  // Index OID definitions
  public static final OID oidIndex =
    new OID(new int[] { 1,3,6,1,4,1,44484,1,8,2,1,10 });
  ...
  public static final int colDirection = 4;
  public static final int colRate = 5;
  public static final int colAEnd = 6;
  public static final int colZEnd = 7;

  // Column index definitions for myEntry:
  public static final int idxName = 0;
  public static final int idxUserLabel = 1;
  public static final int idxDirection = 2;
  public static final int idxRate = 3;
  public static final int idxAEnd = 4;
  public static final int idxZEnd = 5;
...
//--AgentGen END
  ...
  /**
   * Constructs a TopologicalLink instance without actually creating its
   * <code>ManagedObject</code> instances. This has to be done in a
   * sub-class constructor or after construction by calling 
   * {@link #createMO(MOFactory moFactory)}. 
   */
  protected TopologicalLink() {
//--AgentGen BEGIN=_DEFAULTCONSTRUCTOR
//--AgentGen END
  }

  /**
   * Constructs a TopologicalLink instance and actually creates its
   ...
   */
  public TopologicalLink(MOFactory moFactory) {
  	this();
    createMO(moFactory);
...
//--AgentGen END
  ...
  private void createMyEntry(MOFactory moFactory) {
    ...
    // Columns
    MOColumn[] myEntryColumns = new MOColumn[6];
    ...
    myEntryColumns[idxRate] = 
      moFactory.createColumn(colRate, 
                             SMIConstants.SYNTAX_OCTET_STRING,
                             moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_ONLY));
    myEntryColumns[idxAEnd] = 
      moFactory.createColumn(colAEnd, 
                             SMIConstants.SYNTAX_OCTET_STRING,
                             moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_ONLY));
    myEntryColumns[idxZEnd] = 
...
//--AgentGen END
  ...
  // Textual Definitions of MIB module TopologicalLink
