...
,MOServerLookupListener
{
  ...
  private static final LogAdapter LOGGER = 
      LogFactory.getLogger(TPData.class);
...
//--AgentGen END
   ...
   */
  public static final OID oidTPData =
  ...
  public static final OID oidMyEntry = 
    new OID(new int[] { 1,3,6,1,4,1,44484,1,17,2,1 });

  // Index OID definitions
  public static final OID oidTpindex =
    new OID(new int[] { 1,3,6,1,4,1,44484,1,17,2,1,1 });
...
//--AgentGen END
  ...
  /**
   * Constructs a TPData instance without actually creating its
...
//--AgentGen END
  ...
  /**
   * Constructs a TPData instance and actually creates its
   ...
   */
  public TPData(MOFactory moFactory) {
  	this();
    createMO(moFactory);
...
//--AgentGen END
  ...
  private void createMyEntry(MOFactory moFactory) {
    ...
    myEntryIndexes = 
      new MOTableSubIndex[] {
      moFactory.createSubIndex(oidTpindex, 
    ...
    myEntryColumns[idxTpName] = 
      moFactory.createColumn(colTpName, 
...
//--AgentGen END
  ...
  public class MyEntryRow extends DefaultMOMutableRow2PC {
    ...
    public OctetString getTpName() {
     //--AgentGen BEGIN=myEntry::getTpName
     //--AgentGen END
      return (OctetString) super.getValue(idxTpName);
    }  
    
    public void setTpName(OctetString newValue) {
     //--AgentGen BEGIN=myEntry::setTpName
     //--AgentGen END
      super.setValue(idxTpName, newValue);
    }
...
//--AgentGen END
  ...
  // Textual Definitions of MIB module TPData
