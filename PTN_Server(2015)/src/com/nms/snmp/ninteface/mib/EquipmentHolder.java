...
//--AgentGen END
{
  ...
  private static final LogAdapter LOGGER = 
      LogFactory.getLogger(EquipmentHolder.class);
...
//--AgentGen END
   ...
   */
  public static final OID oidEquipmentHolder =
  ...
  public static final OID oidMyEntry = 
    new OID(new int[] { 1,3,6,1,4,1,44484,1,15,2,1 });

  // Index OID definitions
  public static final OID oidEquipindex =
    new OID(new int[] { 1,3,6,1,4,1,44484,1,15,2,1,1 });
  ...
  public static final int colHolderType = 5;
  public static final int colHolderState = 6;
  ...
  public static final int idxHolderType = 3;
  public static final int idxHolderState = 4;
...
//--AgentGen END
  ...
  /**
   * Constructs a EquipmentHolder instance without actually creating its
   * <code>ManagedObject</code> instances. This has to be done in a
   * sub-class constructor or after construction by calling 
   * {@link #createMO(MOFactory moFactory)}. 
   */
  protected EquipmentHolder() {
//--AgentGen BEGIN=_DEFAULTCONSTRUCTOR
//--AgentGen END
  }

  /**
   * Constructs a EquipmentHolder instance and actually creates its
   ...
   */
  public EquipmentHolder(MOFactory moFactory) {
  	this();
    createMO(moFactory);
...
//--AgentGen END
  ...
  // Textual Definitions of MIB module EquipmentHolder
