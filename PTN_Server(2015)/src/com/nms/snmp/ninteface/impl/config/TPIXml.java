...
public class TPIXml {
	...
	public String getTPIXml() {
		...
		String[] xmlPath = {"snmpData\\NRM", "CM-PTN-TPI-A1-"+version+"-"+this.getTime()+".xml"};
	...
	private Element createFileContent(Document doc,List<Tunnel> tunnelList) {
		...
		for (Tunnel tunnel :tunnelList) {
			...
			Object.setAttribute("rmUID","4201EBCRD1"+tunnel.getAprotectId());
			this.createElementNode(doc, "N", "4201EBCRD1"+tunnel.getAprotectId(), Object, "i", "1");
